...
import { urlMinister, assetUrl } from 'src/endpoints'
function Minister({ user }) {
  ...
  useEffect(() => {
    axios.get(urlMinister).then((res) =>{ setMinister(res.data)
  ...
  return (
    <>
      <CModal size="xl" visible={visibleXL} onClose={() => setVisibleXL(false)}>
        ...
        >
          <CModalTitle>Ministers Profile </CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CCardBody>
            <MDBRow>
              <MDBCol lg="4">
                <MDBCard className="mb-4">
                  <MDBCardBody className="text-center">
                    <MDBCardImage
                      src={getImage(ministers.userPhoto)}
                      alt="avatar"
              ...
              <MDBCol lg="12">
                <MDBCard className="mb-4">
                  <MDBCardBody>
                    <div dangerouslySetInnerHTML={{ __html: ministers.description }}></div>
                  </MDBCardBody>
                </MDBCard>
              </MDBCol>
            </MDBRow>
