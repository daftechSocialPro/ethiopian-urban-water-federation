...
import { urlRegion, urlRegionalFederation } from '../../../endpoints'
    ...
    try {
      ...
      axios
        ...
        .then((res) => {
          ...
          customToast('Regional Association Successfully created', 0)
        })
        .catch((err) => {
          setIsLodding(false)
          alert(err)
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader style={{ backgroundColor: '#1e4356', color: '#fff' }} className="">
            <CRow>
              <CCol sm={10}>
                <strong>Regional Association </strong> <small>Create</small>
              </CCol>
            </CRow>
          </CCardHeader>
